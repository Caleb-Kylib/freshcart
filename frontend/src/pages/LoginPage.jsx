...
import { Mail, Lock, ArrowRight, AlertCircle, Eye, EyeOff, Check, Loader2, ShoppingBasket } from "lucide-react";
      ...
      <div className="flex flex-col justify-center items-center lg:col-span-7 px-4 py-12 md:py-16 bg-brand-bg relative min-h-screen">
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 rounded-2xl border border-gray-200 focus:border-brand-primary focus:ring-4 focus:ring-emerald-50 outline-none transition-all duration-200 bg-white placeholder-gray-400 text-brand-dark shadow-sm text-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link to="/forgot-password" className="text-xs font-extrabold text-brand-primary hover:text-brand-secondary transition-colors underline-offset-2 hover:underline">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-12 py-3.5 rounded-2xl border border-gray-200 focus:border-brand-primary focus:ring-4 focus:ring-emerald-50 outline-none transition-all duration-200 bg-white placeholder-gray-400 text-brand-dark shadow-sm text-sm"
                />
                <button
                  type="button"
                  disabled={isLoading}
              ...
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <div className="relative flex items-center justify-center">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <div className={`w-5 h-5 rounded-md border transition-all duration-200 flex items-center justify-center shadow-sm ${
                    rememberMe 
                      ? 'bg-brand-primary border-brand-primary text-white scale-100' 
                      : 'border-gray-300 bg-white group-hover:border-brand-primary'
                  }`}>
                    {rememberMe && <Check size={14} className="stroke-[3.5]" />}
                  </div>
                </div>
                <span className="text-sm text-brand-muted group-hover:text-brand-dark font-medium transition-colors select-none">
                  Remember me
                </span>
              </label>
            </div>
          ...
          <p className="text-center text-sm mt-8 text-brand-muted font-medium">
            ...
            <Link to="/signup" className="text-brand-primary font-extrabold hover:text-brand-secondary transition-colors underline-offset-4 hover:underline">
              Create Account
            </Link>
          </p>
        </motion.div>
